...
<body>
    ...
    <div class="main-content">
        ...
        <form action="search.php" method="GET">
            <input type="text" name="query" placeholder="Search for Songs ヾ(•ω•`)o" style="font-family:Poppins; padding: 10px; width: 1280px; border: 1px solid #ccc; border-radius: 4px 0 0 4px;">
            <button type="submit" style="font-family:Poppins; background-color: #007BFF; color: white; border: 1px solid #007BFF; border-radius: 0 4px 4px 0; padding: 10px 10px; cursor: pointer;">Search</button>
        </form>
        </div>
        <!-- New upload section -->
